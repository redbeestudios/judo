const inserts = require('../../../../src/engine/mssql/statements/insert-output');

describe('Create mssql inserts that output the result from a collection of objects', function () {
